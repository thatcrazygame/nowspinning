...
class SportsDrawer(ViewDrawer):
    def __init__(self) -> None:
        ...
        self.play_scroll = ScrollingText(self.fonts["8x13"], self.white_text, 
                                         0, PANEL_HEIGHT-2, 0, PANEL_WIDTH*2,
    ...
    def get_score_x(self, homeaway: str, score: int,
                    char_width: int = 10) -> int:
    ...
    def get_shots_x(self, homeaway: str, shots: str,
                    char_width: int = 5) -> int:
        if homeaway == HOME:
    ...
    def draw_logos(self, canvas, data: Data, team: Team, league: League, 
                   logo_y: int):
    ...
    async def draw(self, canvas, data: Data):
        ...
        if sport == HOCKEY:
            ...
            self.draw_shots(canvas, team_shots, team_homeaway, font_5x8,
                            white_text)
            
            self.draw_shots(canvas, oppo_shots, oppo_homeaway, font_5x8,
                            white_text)
