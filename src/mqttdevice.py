...
from customdiscoverable import SelectInfo, Select, SharedSensorInfo, SharedSensor
...
class MQTTDevice(object):
    ...
    def __init__(
        self, mqtt_settings: Settings, device_info: DeviceInfo, manual_availability=True
    ) -> None:
    ...
    def _add_entity(
        ...
        callback: Callable[[Client, T, MQTTMessage], Any] = lambda c, t, m: None,
        user_data=None,
        **entity_info
    ):
    ...
    def add_binary_sensor(
        self, manual_availability=None, always_available=True, **entity_info
    ) -> BinarySensor:
    ...
    def add_sensor(
        ...
        return self._add_entity(
            Sensor, SensorInfo, manual_availability, always_available, **entity_info
        )

    def add_shared_sensor(
        self, manual_availability=None, always_available=True, **entity_info
    ) -> SharedSensor:
        sensor = self._add_entity(
            SharedSensor,
            SharedSensorInfo,
            manual_availability,
            always_available,
